...
const EventUpdate = ({id}) => {
    ...
    return (
        <div className='pt-12 md:pt-20 w-[80%] mx-auto'>
            <TitleDashboard title={"Update Your Event"}></TitleDashboard>
                ...
                <div className='flex flex-col md:flex-row md:gap-5'>
                    ...
                    <div className='flex-1'>
                        <div className="form-control">
                            ...
                            <input defaultValue={eventData.eventTitle} {...register("eventTitle")} type="text" placeholder="Event Title" className="input input-bordered text-black" required />
                        </div>
                        <div className="form-control">
                            <label className="label">
                                <span className="label-text text-green-500 text-sm md:text-lg font-medium">Description</span>
                            </label>
                            <input defaultValue={eventData.description} {...register("description")} type="text" placeholder="description" className="input input-bordered text-black" required />
                        </div>
                        <div className="form-control">
                            <label className="label">
                                <span className="label-text text-green-500 text-sm md:text-lg font-medium">Date</span>
                            </label>
                            <input defaultValue={eventData.date} {...register("date")} type="date" placeholder="Date" className="input input-bordered text-black" required />
                        </div>
                    </div>
                    ...
                    <div className='flex-1'>
                        <div className="form-control">
                            ...
                            <input defaultValue={eventData.time} {...register("time")} type="time" placeholder="Time" className="input input-bordered text-black" required />
                        </div>
                        <div className="form-control">
                            <label className="label">
                            ...
                            <select defaultValue={eventData.duration} {...register("duration")} className="select select-bordered w-full text-black" required>
                        ...
                        <div className="form-control">
                            ...
                            <input defaultValue={eventData.image} {...register("image")} type="text" placeholder="Image" className="input input-bordered text-black" required />
                        </div>
