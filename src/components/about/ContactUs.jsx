...
const ContactUs = () => {
  return (
    <section className="bg-gray-100 max-w-6xl mx-auto rounded-xl my-6 shadow-xl mt-5 ">
      <div className=" py-3 lg:py-10 px-4 mx-auto max-w-screen-md">
        ...
        >
          ...
          <button
            type="submit"
            className="py-3 px-2 btn btn-warning rounded-md shadow-xl hover:opacity-60 active:scale-95"
          >
            Send message
          </button>
        </form>
