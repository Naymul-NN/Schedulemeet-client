...
const CustomerPages = () => {
  ...
  return (<>
        ...
        <div className="flex justify-center items-center h-full">
          ...
          <div className="flex justify-between items-center xl:flex-row lg:flexrow flex-col-reverse">
            ...
            <div className="space-y-5">
              ...
              <div>
                <h2 className="text-[60px] font-bold text-[#33A30F]">1,000</h2>
                <p>Placements with Sense by the end of the year</p>
              </div>
    ...
    <div className='bg-gradient-to-r from-[#584c97] to-[#5555d8] text-black'>
