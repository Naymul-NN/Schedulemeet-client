...
<h2 className="text-[#676767]">{seeDatas?.blogTime?.dates}-{seeDatas?.blogTime.months}-2024</h2>
</div>
...
<Image className="block w-full h-[500px]" src={seeDatas?.blogImage} width={500} height={500} alt="blog Image"></Image> 
