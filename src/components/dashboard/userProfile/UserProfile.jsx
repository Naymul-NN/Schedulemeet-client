...
<div className="border-[1px] rounded-md p-4 h-max shadow-md my-2">
<h2 className="text-center  text-[20px]">Social Link</h2>
...
<div>
<div><h2 className="text-center my-2 bg-[#4A69BD] text-white p-2 w-max mx-auto rounded-md">User Address</h2></div>
...
<div><h2 className="text-center my-2 bg-[#4A69BD] hover:bg-[#577ce1] cursor-pointer text-white p-2 w-max mx-auto rounded-md">Edit Profile</h2></div>
