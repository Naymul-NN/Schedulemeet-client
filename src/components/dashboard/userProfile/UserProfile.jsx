      ...
      <div className="relative top-0 userProfileContainer flex justify-center items-center p-2">
            ...
            <div className=" userProfileWrapper flex flex-col sm:flex-row gap-y-8 sm:gap-y-0 gap-x-1 xmd:gap-x-2  lg:gap-x-4   ">
              ...
              <div className=" w-[94%] xsm:w-[85%] sm:w-[100%] m-auto profileRightSection  border-[1px] rounded-md h-max  shadow-md bg-gray-100 ">
                <div className="bg-[#4A69BD] rounded-tr-md  rounded-tl-md text-white">
                  <h2 className="text-[20px] p-2 text-center">
                    Personal Details
                  </h2>
                </div>
                <div className="p-4">
                  <div>
                    <h2>
                      ...
                      {user?.displayName ? user?.displayName : "Jhon..."}
                    </h2>
                    <h2>
                      <span className="font-bold">Email:</span>{" "}
                      {user?.email ? user?.email : "examle@gmail.com"}
                    </h2>
                  </div>
                </div>
        ...
        <div
          className={`h-max w-[50%] ${
            showUpdate == null ? "hidden" : "block"
          } left-[25%] absolute transition-shadow  ${
            showUpdate
              ? "userAnimation top-[10%] opacity-100"
              : "top-[-200%] userAnimation2"
          } right-[25%] bg-[#fff] border-[1px] border-[#0000003d] z-50 py-10 shadow-lg p-4 rounded-md`}>
          {" "}
            ...
            <div className="p-4 space-y-5">
              <div className="flex flex-wrap gap-2">
                <div>
                  <input
                    ...
                    className="border-[1px] border-[#0000003d] rounded-md px-4 py-2 outline-none"
                    type="text"
                    name="username"
                ...
                <div>
                  <textarea
                    className="border-[1px] border-[#0000003d] rounded-md p-4 outline-none"
                    name="userAbout"
                    defaultValue={
                      userData.userabout ? userData.userabout : "write here"
                    }
                    cols="30"
                    rows="0"></textarea>
                </div>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  <input
                    defaultValue={
                      userData.sociallinks.pinterest
                    ...
                    type="text"
                    name="facebookLink"
                    placeholder="Write your facebook link..."
                  />
                  <input
                    defaultValue={
                      userData.sociallinks.pinterest
                    ...
                    type="text"
                    name="twitterLink"
                    placeholder="Write your twitter link..."
                  />
                  <input
                    defaultValue={
                      userData.sociallinks.pinterest
                    ...
                    type="text"
                    name="linkdinLink"
                    placeholder="Write your linkdin link..."
                  />
                  <input
                    defaultValue={
                      userData.sociallinks.pinterest
                    ...
                    type="text"
                    name="pinterestLink"
                    placeholder="Write your pinterest link..."
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  <input
                    defaultValue={
                      userData.name ? userData.name : "write your name"
                    }
                    className="border-[1px] border-[#0000003d] rounded-md px-4 py-2 outline-none"
                    type="text"
                    name="name"
              ...
              <input
                className="bg-[#4A69BD] my-2 hover:bg-[#577CE1] font-semibold cursor-pointer text-white px-6 py-2 rounded-md mx-auto block w-max"
                type="submit"
                value="Update"
              />
            </div>
